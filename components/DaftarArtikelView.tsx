        ...
        <div className="flex flex-col h-full bg-slate-50">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 pb-24">
                <div className="space-y-4">
                    {/* PERBAIKAN: Tambahkan tipe data pada parameter (artikel: Artikel, index: number) */}
                    {(artikelData as Artikel[]).map((artikel: Artikel, index: number) => (
                        <div
                            key={index}
                            onClick={() => window.location.href = artikel.link}
